...
export const Header = () => {
  return (
    <>
      <div className="fixed top-0 left-0 right-0 bg-white z-50 flex items-center justify-between w-full px-[9px] py-[7.5px] h-[40px] max-w-[375px]  md:hidden font-inter">
