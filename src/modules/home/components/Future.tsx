...
const Future = () => {
  ...
  return (
    <div className="max-w-[375px] mx-auto mt-[65px] font-inter px-[20px] text-white relative md:max-w-[1200px] md:mx-auto md:mt-[180px] md:pl-[270px] md:pr-[20px]">
      ...
      {!!isReady && (
        <motion.div
          initial={animationChuyenKhoa.initial}
          whileInView={animationChuyenKhoa.whileInView}
          transition={animationChuyenKhoa.transition}
          viewport={animationChuyenKhoa.viewport}
      ...
      {!!isReady && (
        <motion.div
          initial={animationHoiDap.initial}
          whileInView={animationHoiDap.whileInView}
          transition={animationHoiDap.transition}
          viewport={animationHoiDap.viewport}
      ...
      {!!isReady && (
        <motion.div
          initial={animationAI.initial}
          whileInView={animationAI.whileInView}
          transition={animationAI.transition}
          viewport={animationAI.viewport}
      ...
      {!!isReady && (
        <motion.div
          initial={animationBacSi.initial}
          whileInView={animationBacSi.whileInView}
          transition={animationBacSi.transition}
          viewport={animationBacSi.viewport}
      ...
      {!!isReady && (
        <motion.div
          initial={animationGiaiPhap.initial}
          whileInView={animationGiaiPhap.whileInView}
          transition={animationGiaiPhap.transition}
          viewport={animationGiaiPhap.viewport}
      ...
      {!!isReady && (
        <motion.div
          initial={animationLuutru.initial}
          whileInView={animationLuutru.whileInView}
          transition={animationLuutru.transition}
          viewport={animationLuutru.viewport}
